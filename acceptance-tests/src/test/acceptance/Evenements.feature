Feature: Fonctionnalités de la page models
  ...
  Scenario Outline: Vérification de la redirection du bouton de la commande
    ...
    And appuyer sur le bouton news
    And appuyer sur le bouton suivant "Suivant"
    Examples:
  ...
  Scenario Outline: Vérification de la redirection du bouton de la commande
    ...
    And appuyer sur le bouton news
    And appuyer sur le bouton suivant "Suivant"
    And vérifier que le message est "obligatoire"
    Examples:
      |prénom |nom  |téléphone  |region|postal|
      |first  |last |0606060606 |France|75017 |
